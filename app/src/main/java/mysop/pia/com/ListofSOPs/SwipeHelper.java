...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    SwipeHelper(Context context, RecyclerView recyclerView) {
        ...
        @SuppressLint("ClickableViewAccessibility") View.OnTouchListener onTouchListener = (view, e) -> {
    ...
    public static class UnderlayButton {
        ...
        UnderlayButton(String text, int color, UnderlayButtonClickListener clickListener) {
            this.text = text;
            this.color = color;
